...
export default withAuth(class Home extends Component {
  ...
  render() {
    ...
    const mainContent = this.state.authenticated ?
      (
          <div>
        <p className="lead">You are logged into the staff portal, <Link to="/staff"> click here.</Link></p>
        <button className="btn btn-light btn-lg" onClick={this.logout}>Logout</button>
        </div>
      ) :
      (
        <div>
        <p className="lead">If you are a staff member, please get your credentials from you supervisor.</p>
